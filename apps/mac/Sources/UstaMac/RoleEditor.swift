...
struct RoleEditor: View {
    ...
    var existing: Usta_V1_Role? = nil
    var onSave: (Usta_V1_ProposedRole) -> Void
    ...
    init(existing: Usta_V1_Role? = nil,
         onSave: @escaping (Usta_V1_ProposedRole) -> Void) {
        ...
        if let r = existing {
            ...
            // systemPrompt not exposed in Usta_V1_Role; leave blank — editing
