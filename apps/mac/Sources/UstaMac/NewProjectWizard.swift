...
struct NewProjectWizard: View {
    ...
    @State private var proposal: Usta_V1_ProjectProposal? = nil
    @State private var showAddRole: Bool = false
    @State private var working: Bool = false
    @State private var errorMsg: String? = nil
    @State private var openedWS: Usta_V1_Workspace? = nil
    // Grill flow
    ...
    private func grillQuestionCard(index: Int, q: Usta_V1_GrillQuestion) -> some View {
